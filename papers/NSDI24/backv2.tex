...
programmable switches in disaggregated settings, and remote
memory.
...
control---and provide brief overviews.
...
%\todo{In Ditto they make the argument again sherman that they cannot support locks due to the number
%of redundent CAS operations and actually take numbers in figure 2 of their paper~\cite{ditto}}
