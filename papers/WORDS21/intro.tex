...
data~\cite{job_throughput,infiniswap,leap,legoos}.
...
distributed data
structures~\cite{farm,erpc,herd,fasst,pilaf,cell,sonuma,storm}.
However, they require a CPU be co-resident with remote memory to
coordinate accesses and keep the remote data structures consistent.
If under-powered, this CPU can easily become a performance bottleneck;
conversely, locating significant processing power next to remote
memory defeats the original goal of disaggregation.  Researchers have
