...
Resources on networking hardware are scarce. High end SoC SmartNIC's
...
keys. Note that 100~K keys can be supported using 2.5\% of the available
memory on a Barefoot Tofino 2 programmable switch (64~MB)~\cite{tofino2}.
