...
or paging system ~\cite{rethinking}. Alternatively the use of commodity hardware to access and
control remote memory is referred to as \textit{far memory} ~\cite{reigons,fastswap,
legoos, clover, lite}. In this work we concentrate on the latter, our
...
~\cite{fastswap,GMS,infiniswap,leap,ramcloud}. Transparency costs performance systems
