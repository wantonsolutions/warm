...
Moreover, {\sword} can leverage RDMA transport ordering to remove the
...
Further, by removing the need for RDMA atomics, we 
scale past the ConnectX atomic limit of $\approx$2.7 MOP/s per queue
pair.
