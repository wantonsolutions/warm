...
\begin{figure}[t]
    ...
    \caption{Percentage of stale reads made on a 50\% write workload \todo{repeat for reads and write on new setup (likely higher percentage)}}
...
operation.  Figure~\ref{fig:stale_reads} shows the percentage of
operation attempts that fail under a 50:50 read-write workload as a
...
\begin{figure}[t]
    ...
    distribution. The majority of packets have monotonic sequence numbers,
    however reorderings of up to 15 packets can occur.}
...
\textbf{XXX} operations per second to 1,000 different memory
...
%% pairs.\sg{given a zipf distribution, and 16qp around 3\% of packets are
