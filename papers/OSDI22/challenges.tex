...
\begin{figure}[t]
    ...
    \caption{Percentage of successful read and write attempts on 1024 keys at a
    50\% write workload \textit{zipf(0.99)} as more client threads are added. At
    128 threads 26\% of write attempts are successful using optimistic
    concurrency.}
