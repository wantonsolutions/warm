...
2.82$\times$ throughput improvement as nearly all requests
succeed.
...
\begin{figure}
    ...
    \caption{Bytes required per Clover operation for each of the three techniques for different write intensities.}
