...
%  \vskip -0.5em
    ...
    right. Our improvements over Clover are 1.0x, 2.8x, 32x, and 46x respectively.}
...
performance. Specifically, we extract the CAS request from Shermans's
...
%\vskip -1em
    \caption{99th-percentile tail latencies of reads (solid) and writes
