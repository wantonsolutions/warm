...
\begin{figure}
  ...
  \centering
   \vskip -0.5em
    \caption{Bytes required per Clover operation for each of the three techniques for different write intensities.\todo{These are DPDK numbers re-run with the pswitch}}
