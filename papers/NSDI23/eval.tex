...
\subsubsection{Partial key tracking}
...
are on lower keys). We add keys to \swords tracking list in order of hotness by
chunks of 8. At this distribution tracking only the hottest 8 keys provides a
9.5x performance improvement, and tracking the hottest 64 provides 27x.
