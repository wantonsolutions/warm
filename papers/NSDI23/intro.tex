...
memory is still on the horizion as DRAM access times remain
...
plentiful~\cite{infiniswap,fastswap,legoos,clover,sherman,farm}

% Considerable headway has been made at higher
