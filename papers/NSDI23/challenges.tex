...
Hence, a scalable far memory system should avoid the use of course grained
locking with atomics to the extent possible, instead relying upon, lightweight
RDMA verbs and fine grained locks.  
%%
