...
stage for queue pairs, sequence numbers, and connection IDs. \sword's
...
generated. RDMA invariant CRCs are tricky as P4 hardware does not
support generating them directly. We bypass them in P4 by turning off
the ICRC check on our CX5 NICs---the Ethernet CRC provides guarantees.
%at rack scale.
