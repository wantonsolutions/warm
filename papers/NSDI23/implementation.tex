...
and tracking connections, and resolving read and write conflicts. Connection
multiplexing is implemented separately on a DPDK middlebox discussed further in this section.

an in-line middlebox using DPDK,
...
general purpose, and compartmentalizes application-specific logic to
the extent possible.
