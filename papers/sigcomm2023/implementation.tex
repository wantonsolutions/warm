...
limitations of our switch, the DPDK
...
previous section---including ICRC recalculation.
%(see Appendix~\ref{sec:appendix_icrc}).
In this section we describe why
tracking outstanding requests and de-coalescing ACKs is challenging in
