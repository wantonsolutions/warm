...
due to ethernet CRC ~\cite{p4telemetry,bedrock}.  Hence,
like previous authors~\cite{switchml}, we disable ICRC
checks on both the sender and receiver NICs to save switch
resources in our experiments.
