...
\begin{figure}
    \center
    \includegraphics[width=0.99\textwidth]{fig/full_system_performance-c.pdf}
...
% (Results for a range of sizes are presented in Appendix~\ref{ss:psize}.)
%a
...
experiments---to enhance the locality of requests.
  % (See Appendix~\ref{ss:zipf} for a full range.)
