...
plot_data(axs,'cns_contention_control.dat','CAS',default_color,default_marker)
plot_data(axs,'cns_contention_fix.dat','CAS -> write',cas_color,cas_marker)
#axs.set_title("csn raw vs write to CNS")
axs.set_ylim(1,3)

figure_name="cns_vs_swap"
