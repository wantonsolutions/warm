...
rw_ops=[392147,661200,1116841,1770007,2538991,3703115,4402970,]
rw_threads=[2,4,8,16,32,48,64,]
rw_bandwidth=[493113088,830118324,1401439700,2219440700,3183032764,4641466952,5518274284,]

w_ops=[383884,645433,1082635,1781504,2573263,3717422,4437014,]
w_threads=[2,4,8,16,32,48,64,]
w_bandwidth=[504572704,849213744,1439004704,2402741148,3597276744,5392313732,6651664700,]

clover_ops=[383906,646731,1080108,1792093,2594507,3787707,4499509,]
clover_threads=[2,4,8,16,32,48,64,]
clover_bandwidth=[504786548,850982624,1436378204,2418559176,3624836416,5475258520,6713040012,]

 

#static_plot_attributes(ax1,cns_replacement_A,qp_mapping_A,read_write_steering_A,write_steering_A,clover_with_buffering_A)

plot_optimial(ax1,5,clover_threads)
