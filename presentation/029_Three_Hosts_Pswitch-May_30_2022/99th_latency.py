...
def plot_latency(ax, clover, write, rw, mode):
    ...
    ax.errorbar(x - width, clover[lat_label], yerr=clover[err_label], color='k', marker=',', ls='none')
    ax.errorbar(x, write[lat_label], yerr=write[err_label], color='k',marker=',', ls='none')
    ax.errorbar(x + width, rw[lat_label], yerr=rw[err_label], color='k' ,marker=',', ls='none')
